/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: e7726610c44e94a3a446526db3e48fcb)
...
declare namespace Cloudflare {
	...
	interface Env {
		nowplaying_gorilla: KVNamespace;
		LISTEN_BRAINZ_USER_NAME: string;
		MISSKEY_TOKEN: string;
		MISSKEY_HOST: string;
		MISSKEY_PAGE_ID: string;
	}
}
